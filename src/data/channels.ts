...
export function getOfficialChannels(): OfficialChannel[] {
  const areas = [...malaysiaAreas, ...singaporeAreas, ...thailandAreas, ...indonesiaAreas, ...vietnamAreas, ...philippinesAreas, ...bruneiAreas, ...japanAreas, ...southKoreaAreas, ...taiwanAreas, ...hongKongAreas];
