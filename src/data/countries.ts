...
export const countries: CountryMeta[] = [
  ...
  },
  {
    ...
    teaser: {
      en: "High mountain trails to Yushan, Northeast Asia's tallest peak, and a drive-up 3,400-metre sunrise at Hehuanshan.",
      ms: 'Laluan gunung tinggi ke Yushan, puncak tertinggi Asia Timur Laut, dan matahari terbit 3,400 meter boleh dipandu di Hehuanshan.',
      'zh-cn': '通往东北亚最高峰玉山的高山路线，以及在合欢山驱车可达、海拔3,400米的日出美景。',
      'zh-hk': '通往東北亞最高峰玉山嘅高山路線，以及喺合歡山揸車可以去到、海拔3,400米嘅日出美景。',
      ta: 'வடகிழக்கு ஆசியாவின் மிக உயரமான சிகரமான யுஷானுக்கான உயர மலைப் பாதைகள், மற்றும் ஹேஹுவான்சானில் ஓட்டிச் செல்லக்கூடிய 3,400 மீட்டர் சூரிய உதயம்.',
      ar: 'مسارات جبلية عالية إلى يوشان، أعلى قمم شمال شرق آسيا، وشروق عند ارتفاع 3,400 متر يُبلَغ بالسيارة في هيهوانشان.',
    },
  },
  {
    slug: 'hong-kong',
  ...
  },
  {
    ...
    teaser: {
      en: "From Huangshan's granite pillars to Zhangjiajie's floating sandstone peaks and the sacred summit above Yubeng.",
      ms: 'Dari tiang granit Huangshan hingga puncak batu pasir terapung Zhangjiajie dan puncak suci di atas Yubeng.',
      'zh-cn': '从黄山花岗岩石柱到张家界浮空砂岩峰，再到雨崩村上方的神圣山峰。',
      'zh-hk': '由黃山花崗岩石柱到張家界浮空砂岩峰，再到雨崩村上方嘅神聖山峰。',
      ta: 'ஹுவாங்ஷானின் கிரானைட் தூண்களில் இருந்து ஷாங்ஜியாஜியின் மிதக்கும் மணற்கல் சிகரங்கள் மற்றும் யுபெங்கிற்கு மேலே உள்ள புனித சிகரம் வரை.',
