...
- **`src/data/config.ts`** — `SAFETY_CONTACT_EMAIL` powers the "report a concern" mailto button on `/safety/`. It's currently a placeholder (`safety@bbmw0.com`) — set it to a real, monitored address before launch.
